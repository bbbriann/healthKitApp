...
struct CalenderView: View {
    ...
    @Binding var hasCalendarButtonPressed: Bool
    
    init(clickedCurrentMonthDates: Binding<Date>,
         hasCalendarButtonPressed: Binding<Bool>) {
        _clickedCurrentMonthDates = clickedCurrentMonthDates
        _month = State(initialValue: clickedCurrentMonthDates.wrappedValue)
        _hasCalendarButtonPressed = hasCalendarButtonPressed
    }
...
private extension CalenderView {
    ...
    func canMoveToPreviousMonth() -> Bool {
        ...
        let calendar = Calendar.current
        let targetDate = calendar.date(byAdding: .month, value: -120, to: month) ?? currentDate
